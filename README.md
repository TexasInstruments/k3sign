...
--sysfw /dmsc/system-firmware/ti-sci-firmware-j721e-gp.bin \
--signing-key /home/a0393778/work/dmsc/degenerateKey.pem \
--log-level DEBUG \
...
``` {.bash}
$ k3sign.py sbl-v2 --sbl dmsc_r5_test.bin \
--sysfw /dmsc/system-firmware/ti-sci-firmware-j7200-gp.bin \
--signing-key /home/a0393778/work/dmsc/degenerateKey.pem \
--sysfw-data /dmsc/system-firmware-test/boardcfg-combined.bin \
